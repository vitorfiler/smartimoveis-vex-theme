...
export class HomeComponent implements OnInit {
  ...
  public listProperties: Property[];
  public slides = [];
  ...
  public getProperties(){  
    ...
    this.listProperties = JSON.parse(properties);
      ...
      let result = this.filterData(this.listProperties); 
  ...
  public getFeaturedProperties(){
    var properties = localStorage.getItem("properties");
    this.listProperties = JSON.parse(properties);
      this.featuredProperties = this.listProperties;
