...
export class PropertyItemComponent implements OnInit {
  ...
  public LengthGallery1: boolean = this.lengthGallery(); 
  public LengthGalleryMaiorQue1: boolean = this.lengthGalleryMaiorQue1(); 
  ...
  lengthGallery(){
    if(this.property && this.property.gallery.length == 1){
      return true
    } 
    return false;
  }
  lengthGalleryMaiorQue1(){
    if(this.property && this.property.gallery.length > 1){
      return true
    } 
    return false;
  ...
  ngOnInit() { 
    ...
    // if(this.property && this.property.area){
    //   this.listArea = this.property.area;
    //   console.log(this.listArea.value);
    // }
    // console.log(this.property.area);
